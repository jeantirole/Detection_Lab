...
#     # # get raw image size    
#     orig_w = int(root.findall('size')[0].find("width").text)
#     orig_h = int(root.findall('size')[0].find("height").text)
...
#             xmin = float(box_.find("xmin").text)
#             ymin = float(box_.find("ymin").text)
#             xmax = float(box_.find("xmax").text)
#             ymax = float(box_.find("ymax").text)
