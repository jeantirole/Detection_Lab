...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file='anns',
        data_root=
        '/mnt/hdd/eric/.tmp_ipy/00.Data/ShipRS_dataset/ShipRSImageNet_V1/DOTA_Format',
        datasets=[
            dict(
...
val_dataloader = dict(
    ...
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(interval=3, metric='mAP', type='DOTAMetric')
val_pipeline = [
    dict(backend_args=None, type='mmdet.LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
        800,
