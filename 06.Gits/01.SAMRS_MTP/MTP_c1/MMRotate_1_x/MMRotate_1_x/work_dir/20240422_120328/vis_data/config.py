...
default_hooks = dict(
    checkpoint=dict(interval=8, type='CheckpointHook'),
    ...
    visualization=dict(
        draw=True,
        test_out_dir=
        '/mnt/hdd/eric/.tmp_ipy/15.Lab_Detection/06.Gits/01.SAMRS_MTP/MTP/MMRotate_1_x/show_dir',
...
model = dict(
    backbone=dict(
        ...
        patch_size=16,
        pretrained=
        '/data/diwang22/code/pretrn/last_vit_l_rvsa_ss_is_rd_pretrn_model_encoder.pth',
        qk_scale=None,
        qkv_bias=True,
...
test_evaluator = dict(
    ...
    merge_patches=True,
    outfile_prefix=
    '/data/diwang22/code/RS-MTP-workdir/finetune/Rotated_Detection/dotav2_ss/oriented_rcnn_rvsa_l_1024_mae_mtp_dota20/test/submit/oriented_rcnn_rvsa_l_1024_mae_mtp_dota20',
    type='DOTAMetric')
test_pipeline = [
    dict(backend_args=None, type='mmdet.LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
train_cfg = dict(max_epochs=40, type='EpochBasedTrainLoop', val_interval=8)
