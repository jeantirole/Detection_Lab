...
#-- datasets 
train_dataset = dataset_rs.Seg_RS_dataset(img_dir=img_path, mask_dir=mask_path, image_resize = None, phase="train" )
train_loader  = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True, collate_fn=train_dataset.collate_fn)
valid_dataset = dataset_rs.Seg_RS_dataset(img_dir=img_path, mask_dir=mask_path, image_resize = None, phase="train" )
