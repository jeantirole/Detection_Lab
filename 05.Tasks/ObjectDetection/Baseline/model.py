...
class RegionProposalNetwork(nn.Module):
    def __init__(self, img_size, out_size, out_channels):
        ...
        self.anc_scales = [2, 4, 6, 8, 10] # 2 4 6 default
        self.anc_ratios = [0.5, 1, 1.5]  # 0.5 1 1.5 default
...
class ClassificationModule(nn.Module):
    def __init__(self, out_channels, n_classes, roi_size, hidden_dim=512, p_dropout=0.3):
        ...
        # for light-head
        self.conv1by1 = nn.Conv2d(kernel_size=1,in_channels=2048,out_channels=490)
        self.fc1 = nn.Linear(490,256)
        self.cls_head1 = nn.Linear(256,n_classes)
    ...
    def forward(self, feature_map, proposals_list, gt_classes=None):
        ...
        #---------- 
        # Eric
        # Channel reduction refer to Light-Head RCNN 
        #feature_map = self.conv1by1(feature_map)
        ...
        out = self.fc(roi_out)
        #out = self.fc1(roi_out)
        out = F.relu(self.dropout(out))
        
        # get the classification scores
        cls_scores = self.cls_head(out)
        #cls_scores = self.cls_head1(out)
