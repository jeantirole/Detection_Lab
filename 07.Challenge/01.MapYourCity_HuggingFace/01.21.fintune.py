...
parser.add_argument('--cfg', type=str, \
                    default='/mnt/hdd/eric/.tmp_ipy/15.Lab_Detection/07.Challenge/01.MapYourCity_HuggingFace/configs/finetune_21.yaml')
...
for fold, (train_ids, valid_ids) in enumerate(SKF.split(names_data,names_label)):
    ...
    train_set = map_dataset.Map_Dataset_v11(train_names,train_path,max_size=data_config['input_size'][1],cfg=cfg,split='train') 
    valid_set = map_dataset.Map_Dataset_v11(valid_names,train_path,max_size=data_config['input_size'][1],cfg=cfg,split='valid')  
