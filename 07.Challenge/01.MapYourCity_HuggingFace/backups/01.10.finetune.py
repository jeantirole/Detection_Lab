...
parser.add_argument('--cfg', type=str, default='/mnt/hdd/eric/.tmp_ipy/15.Lab_Detection/07.Challenge/01.MapYourCity_HuggingFace/configs/finetune_11.yaml')
...
for epoch in range(cfg.EPOCHS):
    ...
    if cfg.LOSS_FN == "CE" or "KL":
        ...
        #-- evaluate validation
        valid_precision, valid_recall, valid_f1, valid_accuracy = map_train.test_v4_2(testloader, model, val_loss_fn,cfg,metric_obj)
        ...
        #-- evaluate validation
        regression_loss = map_train.test_v4_2(testloader, model, val_loss_fn,cfg,metric_obj)
