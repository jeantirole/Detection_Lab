...
for epoch in range(cfg.EPOCHS):
    ...
    # Valid
    top1_acc, top5_acc = map_train.test_v1(testloader, model, val_loss_fn,cfg)
    if top1_acc > best_top1_acc:
        best_top1_acc = top1_acc
        best_top5_acc = top5_acc
        torch.save(model.state_dict(), os.path.join(cfg.SAVE_DIR, f"{cfg.RUN_VERSION}_{cfg.MODEL}_epoch_{epoch}.pth"))
