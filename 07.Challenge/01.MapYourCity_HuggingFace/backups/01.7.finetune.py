...
if cfg.TIMM:
    train_set = map_dataset.Map_Dataset_v6(names_train,train_path,max_size=data_config['input_size'][1],cfg=cfg,split='train') 
...
for epoch in range(cfg.EPOCHS):
    ...
    accum_time = 0
    # Train 
    for iteration, (str_imgs,top_imgs, labels) in enumerate(trainloader):
