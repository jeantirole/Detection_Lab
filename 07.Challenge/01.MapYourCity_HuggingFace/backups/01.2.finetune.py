...
parser.add_argument('--cfg', type=str, default='/mnt/hdd/eric/.tmp_ipy/15.Lab_Detection/07.Challenge/01.MapYourCity_HuggingFace/configs/finetune_2.yaml')
...
if cfg.TIMM:
    train_set = map_dataset.Map_Dataset_v2(names_train,train_path,max_size=data_config['input_size'][1]) 
    valid_set = map_dataset.Map_Dataset_v2(names_valid,train_path,max_size=data_config['input_size'][1])  
else:
    train_set = map_dataset.Map_Dataset_v2(names_train,train_path,max_size=cfg.IMAGE_SIZE[0]) 
    valid_set = map_dataset.Map_Dataset_v2(names_valid,train_path,max_size=cfg.IMAGE_SIZE[0])
