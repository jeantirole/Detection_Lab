...
'''
patch note 01.14
1. Train Evaluation pipes changed
2. Sample Train for Street
3. Augmentation added run 
...
parser.add_argument('--cfg', type=str, \
                    default='/mnt/hdd/eric/.tmp_ipy/15.Lab_Detection/07.Challenge/01.MapYourCity_HuggingFace/configs/finetune_16.yaml')
...
if cfg.TIMM:
    train_set = map_dataset.Map_Dataset_v11(names_train,train_path,max_size=data_config['input_size'][1],cfg=cfg,split='train') 
    valid_set = map_dataset.Map_Dataset_v11(names_valid,train_path,max_size=data_config['input_size'][1],cfg=cfg,split='valid')  
...
for epoch in range(cfg.EPOCHS):
    ...
    if cfg.LOSS_FN == "CE" or "KL":
        ...
        precision_,recall_, f1_, acc_  = map_train.test_v6(trainloader, model, val_loss_fn,cfg,metric_obj_train)
