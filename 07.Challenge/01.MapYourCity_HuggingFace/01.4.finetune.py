...
if cfg.TIMM:
    ...
    train_set = map_dataset.Map_Dataset_v3(names_train,train_path,max_size=cfg.IMAGE_SIZE[0]) 
    valid_set = map_dataset.Map_Dataset_v3(names_valid,train_path,max_size=cfg.IMAGE_SIZE[0])
